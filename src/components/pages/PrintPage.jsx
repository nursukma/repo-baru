        ...
        <div ref={ref}>
          <MDBCard style={{ width: "100%", marginTop: "1rem"}}>
            <MDBCardHeader color="mdb-color lighten-3" style={{ width: "100%", height: "8rem"}}>
              ...
              <MDBCol md="6" style={{position: "relative", textAlign: "center", marginTop: "2.7rem", marginLeft: "7rem", marginRight: "6rem"}}> <strong><center>SI PENTING  </center></strong></MDBCol>
          ...
          <div style={{ marginTop: "2rem" }}>
            <MDBTable borderless>
              ...
              <tr>
                <th color="primary-color">Hasil Prediksi</th>
                <th>{props.rekomendasi}</th>
              </tr>
            </MDBTable>
            <MDBTable
              striped
